...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('interview_sessions', function (Blueprint $table) {
            ...
            $table->foreignId('interview_id')->nullable()->constrained()->onDelete('cascade'); // If part of formal interview
            $table->foreignId('job_posting_id')->nullable()->constrained()->onDelete('set null'); // If job-specific
