<x-modal-card title="Edit Resume" name="editResumeModal" blur="md" max-width="5xl">
    <div x-data="{
        tab: 'basic',
        experiences: [],
        educations: [],
    ...
    <x-slot name="footer" class="flex justify-between items-center gap-x-4">
        ...
        <div class="flex gap-x-4">
            ...
            <x-button primary icon="check" label="Update Resume" wire:click="updateResume" spinner />
        </div>
    </x-slot>
</x-modal-card>
